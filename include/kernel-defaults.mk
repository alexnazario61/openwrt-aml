...
#  ifeq ($(strip $(CONFIG_KERNEL_GIT_CLONE_URI)),"")
	...
	$(Kernel/Patch/Generic)
	$(Kernel/Patch/Amlogic)
	touch $(LINUX_DIR)/.quilt_used
    endef
#  else
#    define Kernel/Prepare/Default
#	git clone --depth 1 $(KERNEL_GIT_OPTS) $(CONFIG_KERNEL_GIT_CLONE_URI) $(LINUX_DIR)
#	$(Kernel/Patch/Amlogic)
#	touch $(LINUX_DIR)/.quilt_used
#    endef
#  endif
...
define Kernel/CopyDTBS
	$(CP) $(LINUX_DIR)/arch/$(LINUX_KARCH)/boot/dts/amlogic/$(subst ",,$($(PROFILE)_KERNELDTS).dtb) $(KERNEL_BUILD_DIR)
endef
...
define Kernel/CompileImage/Default
	...
	#")
	+$(MAKE) $(KERNEL_MAKEOPTS) $(subst ",,$($(PROFILE)_KERNELDTS).dtd)
	#")
	+$(MAKE) $(KERNEL_MAKEOPTS) $(subst ",,$($(PROFILE)_KERNELDTS).dtb)
	#")
	$(call Kernel/CopyImage)
	$(call Kernel/CopyDTBS)
endef
