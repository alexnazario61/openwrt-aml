...
/*******************************************************************************
**
** Function         bta_pbs_co_get_version_database_info
**
** Description      This function is called by BTA to inquire about pb primary and secondary version
                    counter and database ID.
**
**
** Returns          pri_ver - primary version counter
**                  sec_ver - secondary version counter
**                  db_id   - database identifier
**
*******************************************************************************/
BTA_API extern tBTA_PBS_CO_STATUS bta_pbs_co_get_version_database_info(tBTA_UINT128 *pri_ver, tBTA_UINT128 *sec_ver, tBTA_UINT128 *db_id);
...
**
*******************************************************************************/
BTA_API extern tBTA_PBS_CO_STATUS bta_pbs_co_getpbinfo(tBTA_PBS_OPER operation, tBTA_PBS_OBJ_TYPE obj_type,
                                                       UINT16 *pb_size, UINT16 *new_missed_call,
                                                       BOOLEAN is_selector, const char *p_path, 
...
/*******************************************************************************
**
** Function         bta_pbs_co_set_newmissedcalls
**
** Description      This function is called by BTA to set newmisscalls for testing
**                  purpose
**
** Parameters       None
**
** Returns          Status: whether set newmissedcalls is successful or not
**
*******************************************************************************/
BTA_API extern tBTA_PBS_CO_STATUS bta_pbs_co_set_newmissedcalls(void);
